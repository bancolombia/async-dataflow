...
defmodule StreamsCore.CloudEventTest do
  use ExUnit.Case
  import Mock
  ...
  @default_mutator_setup %{
    "mutator_module" => StreamsCore.CloudEvent.Mutator.DefaultMutator,
    "config" => nil
  }
  ...
  setup_with_mocks([
    ...
    on_exit(fn ->
      Application.delete_env(:channel_streams, :cloud_event_channel_identifier)
    end)
