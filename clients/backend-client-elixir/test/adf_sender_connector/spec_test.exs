...
defmodule AdfSenderConnector.SpecTest do
  ...
  test "should make http failed request" do
    assert {:error, :econnrefused} = FakeImplementor.send_post_request(%{}, "/some_url")
  end
  ...
  test "should make http sucessful request" do
    ...
    with_mocks([
      ...
      raw_response = FakeImplementor.send_post_request(%{}, "/some_url")
  ...
  test "should hanle http invalid request" do
    ...
    with_mocks([
      ...
      assert {:error, :bad_request} = FakeImplementor.decode_response(raw_response)
    end
  end
  ...
  test "should hanle http unknown error" do
    ...
    with_mocks([
      ...
      assert {:error, :unknown_error} = FakeImplementor.decode_response(raw_response)
    end
  end
