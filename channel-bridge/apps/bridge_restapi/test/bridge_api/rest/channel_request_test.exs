defmodule BridgeApi.Rest.ChannelRequestTest do
  ...
  test "should find app reference in struct data" do
    ...
    with_mocks([
      ...
      ch_req = ChannelRequest.new(sample_headers, %{}, %{}, %{})
      assert ChannelRequest.extract_application(ch_req) == {:ok, %BridgeCore.AppClient{id: "value1", name: ""}}
  ...
  test "should not find app reference in struct data, use default name" do
    ...
    with_mocks([
      ...
      assert ChannelRequest.extract_application(ch_req) == {:ok, %BridgeCore.AppClient{id: "default_app", name: ""}}
  ...
  test "should build app with fixed value from config" do
    ...
    with_mocks([
      ...
      ch_req = ChannelRequest.new(%{}, %{}, %{}, %{})
      assert ChannelRequest.extract_application(ch_req) == {:ok, %BridgeCore.AppClient{id: "fooapp", name: ""}}
