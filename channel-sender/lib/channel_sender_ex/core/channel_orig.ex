...
#       Socket pid: #{inspect(socket_id)} and authenticated. Leaving waiting state.
#       """
#     end)
#     {:next_state,
#       :connected,
#       %{data | socket: socket_id, socket_stop_cause: nil},
#       [
#         _reply = {:reply, from, :ok}
#       ]
#     }
...
#     new_data = %{data | socket: socket_id, socket_stop_cause: nil}
#     actions = [
#       _reply = {:reply, from, :ok}
#     ]
#     Logger.debug("Channel #{data.channel} overwritting socket id.")
...
#     %{data | pending: BoundedMap.put(pending, ref, message, get_param(:max_unacknowledged_queue, 100))}
#   end
