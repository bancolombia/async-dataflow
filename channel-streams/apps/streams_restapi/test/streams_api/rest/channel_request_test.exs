defmodule StreamsApi.Rest.ChannelRequestTest do
  use ExUnit.Case
  use Plug.Test
  import Mock
  ...
  test "should create new struct" do
    ...
    assert %StreamsApi.Rest.ChannelRequest{body: %{}, req_headers: %{}, req_params: %{}, token_claims: %{}}
       == ChannelRequest.new(%{}, %{}, %{}, %{})
  end
  ...
  test "should find app reference in struct data" do
    ...
    with_mocks([
      ...
      assert ChannelRequest.extract_application(ch_req)
       == {:ok, %StreamsCore.AppClient{channel_timeout: 420, id: "value1", name: ""}}
  ...
  test "should not find app reference in struct data, use default name" do
    ...
    with_mocks([
      ...
      assert ChannelRequest.extract_application(ch_req)
        == {:ok, %StreamsCore.AppClient{channel_timeout: 420, id: "default_app", name: ""}}
  ...
  test "should build app with fixed value from config" do
    ...
    with_mocks([
      ...
      ch_req = ChannelRequest.new(%{}, %{}, %{}, %{})
      assert ChannelRequest.extract_application(ch_req) ==
        {:ok, %StreamsCore.AppClient{channel_timeout: 420, id: "fooapp", name: ""}}
  ...
  test "should find user reference in struct data" do
    ...
    with_mocks([
      ...
      ch_req = ChannelRequest.new(sample_headers, %{}, %{}, %{})
      assert ChannelRequest.extract_user_info(ch_req) == {:ok, %StreamsCore.User{id: "value1", name: nil}}
  ...
  test "should not find user reference in struct data, use default name" do
    ...
    with_mocks([
      ...
      ch_req = ChannelRequest.new(%{}, %{}, %{}, %{})
      assert ChannelRequest.extract_user_info(ch_req) == {:ok, %StreamsCore.User{id: "default_user", name: nil}}
  ...
  test "should build user with fixed value from config" do
    ...
    with_mocks([
      ...
      ch_req = ChannelRequest.new(%{}, %{}, %{}, %{})
      assert ChannelRequest.extract_user_info(ch_req) == {:ok, %StreamsCore.User{id: "foouser", name: nil}}
