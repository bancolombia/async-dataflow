defmodule StreamsSecretManagerTest do
  ...
  test "Should obtain plain text secret" do
    with_mocks([
      ...
      result = StreamsSecretManager.get_secret("foo")
  ...
  test "Should obtain json secret" do
    with_mocks([
      ...
      result = StreamsSecretManager.get_secret("bar", output: "json")

      assert {:ok, %{"hostname" => "host", "password" => "b", "port" => 123, "username" => "a"}} == result

      # re-query secret
      result2 = StreamsSecretManager.get_secret("bar", output: "json")
  ...
  test "Should handle error getting secret" do
    with_mocks([
      ...
      result = StreamsSecretManager.get_secret("acme")
