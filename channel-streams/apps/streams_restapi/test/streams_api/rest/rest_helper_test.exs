defmodule StreamsApi.Rest.RestHelperTest do
  use ExUnit.Case, async: false
  use Plug.Test

  alias StreamsApi.Rest.{ChannelRequest, RestHelper}
  ...
  setup do
    ...
    Application.put_env(:channel_streams_ex, :request_user_identifier, ["$.req_headers.key1"])
    Application.put_env(:channel_streams_ex, :request_app_identifier, {:lookup, "$.req_headers.foo"})
    # Application.put_env(:channel_streams_ex, :request_channel_identifier, "$.req_headers['session-tracker']")

    on_exit(fn ->
      Application.delete_env(:channel_streams_ex, :request_user_identifier)
      Application.delete_env(:channel_streams_ex, :request_app_identifier)
      # Application.delete_env(:channel_streams_ex, :request_channel_identifier)
    end)
